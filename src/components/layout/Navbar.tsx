      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        >
          <span className="text-xl md:text-2xl font-black text-slate-900 tracking-tighter uppercase italic group-hover:text-green-600 transition-colors leading-none">
            {t("logo").split(" ")[0]} <br />
            <span className="text-green-600 group-hover:text-slate-900 not-italic">
              {t("logo").split(" ").slice(1).join(" ")}
            </span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-10">
          <Link
            href="/tours"
            locale={locale as any}
            className={`text-xs font-black uppercase tracking-widest transition-colors ${isActive("/tours") ? "text-green-600" : "text-slate-600 hover:text-green-600"}`}
          >
            {common("packages")}
          </Link>
          <Link
            href="/destinations"
            locale={locale as any}
            className={`text-xs font-black uppercase tracking-widest transition-colors ${isActive("/destinations") ? "text-green-600" : "text-slate-600 hover:text-green-600"}`}
          >
          ...
          <Link
            href="/experience"
            locale={locale as any}
            className={`text-xs font-black uppercase tracking-widest transition-colors ${isActive("/experience") ? "text-green-600" : "text-slate-600 hover:text-green-600"}`}
          >
            {t("links.experience")}
          </Link>
          <Link
            href="/about"
            locale={locale as any}
            className={`text-xs font-black uppercase tracking-widest transition-colors ${isActive("/about") ? "text-green-600" : "text-slate-600 hover:text-green-600"}`}
          >
            {t("links.about")}
          </Link>
      ...
      >
        <div className="flex flex-col gap-6">
          ...
          <Link
            ...
            locale={locale as any}
            onClick={() => setIsMobileMenuOpen(false)}
            className={`text-sm font-black uppercase tracking-widest ${isActive("/experience") ? "text-green-600" : "text-slate-900"}`}
          >
            {t("links.experience")}
          </Link>
          <Link
