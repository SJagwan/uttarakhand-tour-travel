...
const steps = [
  {
    ...
    title: "Send Enquiry",
    description: "Fill the form with your travel details and preferences."
  },
  {
    icon: <Map className="w-8 h-8 text-green-600" />,
    title: "We Plan Your Trip",
    description: "Our experts customize the perfect itinerary for you."
  },
  {
    icon: <Calendar className="w-8 h-8 text-green-600" />,
    title: "Start Traveling",
    description: "Confirm your booking and enjoy a hassle-free journey."
  }
];
    ...
    <section className="py-24 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center text-center group animate-in fade-in slide-in-from-right-8 duration-700" style={{ animationDelay: `${i * 200}ms`, animationFillMode: 'both' }}>
              ...
              <div className="mt-6 text-4xl font-black text-slate-200 tracking-tighter italic">0{i+1}</div>
            </div>
          ))}
        </div>
      </div>
