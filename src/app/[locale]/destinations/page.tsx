...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${t("links.destinations")} | ${t("logo")}`,
    description:
      locale === "hi"
      ...
      <header className="bg-slate-50 py-24 border-b border-slate-100">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-6 tracking-tighter uppercase italic">
            {locale === "hi" ? "शीर्ष" : "Top"}{" "}
            <span className="text-green-600 not-italic">
              {t("links.destinations")}
            </span>
          </h1>
          <p className="text-slate-500 text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            {locale === "hi"
              ? "देवों की भूमि के सबसे आध्यात्मिक और सुंदर स्थानों के लिए अंतिम मार्गदर्शिका।"
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest italic">
                      {locale === "hi" ? "अन्वेषण करें" : "Explore"}
                    </span>
                  </div>
